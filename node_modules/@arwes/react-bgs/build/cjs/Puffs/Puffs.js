...
const Puffs = (0, react_tools_1.memo)((props) => {
    ...
    (0, react_1.useEffect)(() => {
        ...
        const background = (0, bgs_1.createBackgroundPuffs)({
            canvas,
    ...
    return (react_1.default.createElement("canvas", { role: "presentation", ref: (0, react_tools_1.mergeRefs)(elementRef, elementRefExternal), id: id, className: (0, tools_1.cx)('arwes-bgs-puffs', className), style: { ...(positioned ? styles_js_1.positionedStyle : null), ...style } }));
});
exports.Puffs = Puffs;
