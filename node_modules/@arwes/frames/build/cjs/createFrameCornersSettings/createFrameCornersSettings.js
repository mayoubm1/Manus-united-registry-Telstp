...
exports.createFrameCornersSettings = void 0;
...
const createFrameCornersSettings = (props) => {
    const { styled, animated, padding: p, strokeWidth: cw, cornerLength: cl } = { ...defaultProps, ...(props ? (0, tools_1.filterProps)(props) : null) };
    const co = cw / 2;
    const linesPaths = [
        [
            ['M', co + p, co + p],
...
exports.createFrameCornersSettings = createFrameCornersSettings;
