...
exports.createFrameCircleSettings = void 0;
...
const createFrameCircleSettings = (props) => {
    const { styled, animated, padding: p, strokeWidth, separation, sideWidth } = { ...defaultProps, ...(props ? (0, tools_1.filterProps)(props) : null) };
                ...
                elements: [
                    {
                        ...
                        animated: animated && {
                            transitions: {
                                entering: ({ element, duration }) => (0, motion_1.animate)(element, { opacity: [0, 1] }, { delay: duration / 2, duration: duration / 2 }),
                                exiting: ({ element, duration }) => (0, motion_1.animate)(element, { opacity: [1, 0] }, { duration: duration / 2 })
                            }
                        },
                        elements: [
                            {
                    ...
                    },
                    {
                        ...
                        animated: animated && {
                            transitions: {
                                entering: ({ element, duration }) => (0, motion_1.animate)(element, { opacity: [0, 1, 0.5, 1], scale: [0.9, 1] }, { duration: duration / 2 }),
                                exiting: ({ element, duration }) => (0, motion_1.animate)(element, { opacity: [1, 0, 0.5, 0], scale: [1, 0.9] }, { delay: duration / 2, duration: duration / 2 })
                            }
                        },
                        elements: [
                            {
...
exports.createFrameCircleSettings = createFrameCircleSettings;
