...
exports.createFrameKranoxSettings = void 0;
...
const createFrameKranoxSettings = (props) => {
    const { styled, animated, padding: p, strokeWidth: sw, bgStrokeWidth: bsw, squareSize: ss, smallLineLength: sll, largeLineLength: lll } = { ...defaultProps, ...(props ? (0, tools_1.filterProps)(props) : null) };
    const so = sw / 2;
    const bso = bsw / 2;
...
exports.createFrameKranoxSettings = createFrameKranoxSettings;
