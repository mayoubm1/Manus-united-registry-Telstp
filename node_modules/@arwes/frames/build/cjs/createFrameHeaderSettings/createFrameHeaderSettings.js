...
exports.createFrameHeaderSettings = void 0;
...
const createFrameHeaderSettings = (props) => {
    const { styled, animated, padding: p, strokeWidth, decoWidth, direction, align, contentLength } = { ...defaultProps, ...(props ? (0, tools_1.filterProps)(props) : null) };
    ...
    const decoDashAnimated = animated
        ? {
            transitions: {
                entering: ({ element, duration }) => (0, motion_1.animate)(element, { opacity: [0, 1, 0.5, 1] }, { duration: duration * 0.4 }),
                exiting: ({ element, duration }) => (0, motion_1.animate)(element, { opacity: [1, 0, 0.5, 0] }, { duration: duration * 0.4, delay: duration * 0.6 })
            }
        }
        : undefined;
    ...
    const decoBoxesAnimated = animated
        ? {
            transitions: {
                entering: ({ element, duration }) => (0, motion_1.animate)(element, { opacity: [0, 1, 0.5, 1] }, { delay: duration * 0.6, duration: duration * 0.4 }),
...
exports.createFrameHeaderSettings = createFrameHeaderSettings;
