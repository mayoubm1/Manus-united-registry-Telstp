const styleSeparator = (props) => {
    const { colorActive, colorStatic, isVertical = false, direction = 'right', width = '0.5rem', space = '0.25rem' } = props;
    return (`linear-gradient(to ${isVertical ? 'bottom' : 'right'}, ` +
        [
