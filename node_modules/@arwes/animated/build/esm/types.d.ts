...
export type EasingName = 'linear' | 'inQuad' | 'outQuad' | 'inOutQuad' | 'inCubic' | 'outCubic' | 'inOutCubic' | 'inQuart' | 'outQuart' | 'inOutQuart' | 'inQuint' | 'outQuint' | 'inOutQuint' | 'inSine' | 'outSine' | 'inOutSine' | 'inExpo' | 'outExpo' | 'inOutExpo' | 'inCirc' | 'outCirc' | 'inOutCirc' | 'inBack' | 'outBack' | 'inOutBack' | 'inElastic' | 'outElastic' | 'inOutElastic' | 'inBounce' | 'outBounce' | 'inOutBounce';
...
export type AnimatedAnimationFunction = ((config: AnimatedAnimationFunctionConfig) => AnimatedAnimationFunctionReturn) | ((config: AnimatedAnimationFunctionConfig) => void);
...
export type AnimatedProp = AnimatedSettings | Array<AnimatedPropPreset | AnimatedPropTransition | AnimatedSettings | false | undefined> | false | undefined;
export type AnimatedXAnimationDefinition = AnimatedAnimationDefinition;
export type AnimatedXAnimationFunctionConfig = Omit<AnimatedAnimationFunctionConfig, 'duration' | 'nodeDuration'>;
export type AnimatedXAnimationFunctionReturn = AnimatedAnimationFunctionReturn;
export type AnimatedXAnimationFunction = ((config: AnimatedXAnimationFunctionConfig) => AnimatedXAnimationFunctionReturn) | ((config: AnimatedXAnimationFunctionConfig) => void);
...
export type AnimatedXProp<States extends string> = AnimatedXSettings<States> | Array<AnimatedXSettings<States> | undefined> | false | undefined;
export {};
