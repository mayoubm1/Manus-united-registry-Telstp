...
const index_js_1 = require("../FrameBase/index.js");
const FrameHeader = (0, react_tools_1.memo)((props) => {
    const { styled, animated, padding, strokeWidth, decoWidth, direction, align, contentLength } = props;
    const settings = (0, react_1.useMemo)(() => (0, frames_1.createFrameHeaderSettings)({
        styled,
        animated,
        padding,
        strokeWidth,
    ...
    return (react_1.default.createElement(index_js_1.FrameBase, { ...props, className: (0, tools_1.cx)('arwes-frames-frameheader', props.className), settings: settings }));
});
